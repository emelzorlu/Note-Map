...
//----veriler null yerine boş dizi olsun----
...
function loadMap(coords) {
  ...
  // ----kullanıcının konumuna imleç basmak----
  L.marker(coords, { icon: userIcon }).addTo(map);

  // ----lokalden gelen verileri ekrana basmak----
...
navigator.geolocation.getCurrentPosition(
  ...
  // ----konumu almazsa varsayılan olarak başlatır----
  () => {
...
function onMapClick(event) {
  // ----tıklanan yerin konumuna eriş global değişken aktar----
